...
description: An analysis project to predict anime "Score" using various machine learning models.
---
...
The goal of this project is to determine which features are most predictive of the "Score" and to identify the machine learning model that provides the best performance.
...
The models were evaluated based on the Root Mean Squared Error (RMSE) on a test set. Feature importance was also analyzed for tree-based models like Gradient Boosting.

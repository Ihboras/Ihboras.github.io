...
description: >
  ...
  This project explores the prediction of anime "Scores" using a dataset from [MyAnimeList](https://myanimelist.net/), 
  which was uploaded to Kaggle. The dataset includes various features about anime, such as genres, episodes, ratings, and more. 

  ## Objective
  The goal of this project is to determine which features are most predictive of the "Score" and to identify the machine learning model 
